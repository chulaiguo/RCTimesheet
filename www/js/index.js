...
function dataBinding($target, data) {
    if ($target.length !== 1)
        return false;
        ...
        if (timesheetPK && imgData) {
            $.ajax({
                ...
                success: function (data) {
                    if (data.OK) {
                        dataBinding($("#" + timesheetPK), data.JsonData);
                    } else {
                        alert(data.Message);
                    }
                ...
                success: function (data) {
                    if (data.OK) {
                        ...
                        for (var i = 0; i < data.JsonData.length; i++) {
                            dataBinding($template, data.JsonData[i]);

                            $template_detail_place_holder.html();
                            for (var j = 0; j < data.JsonData[i].DetailList.length; j++) {
                                dataBinding($template_detail, data.JsonData[i].DetailList[j]);
...
function markEmployeeStatus(status, timesheetPK) {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.OK) {
                dataBinding($("#" + timesheetPK + "|Employee"), data.JsonData);
            } else {
                alert(data.Message);
            }
        },
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.OK) {
                ...
                dataBinding($template, data.JsonData);
...
$(document).on("click", "[data-employee-detail]", function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.OK) {
                dataBinding($("#form_employee_timesheet_detail"), data.JsonData);
...
$(document).on("click", "[data-job-detail]", function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.OK) {
                dataBinding($("#form_job_timesheet_detail"), data.JsonData);
                if (!isRegionManager()) {
...
$(document).on("click", "#save_job_timesheet_edit", function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.OK) {
                dataBinding($("#" +timesheetPK + "|Job"), data.JsonData);
                backToJobHome();
            } else {
                alert(data.Message);
            }
...
$(document).on("click", "#save_region_timesheet_edit", function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.OK) {
                dataBinding($("#" + timesheetPK + "|Region"), data.JsonData);
                backRegionPage();
            } else {
                alert(data.Message);
            }
...
window.startRemotingApp = function (remote_url_base) {
